...
export default function KingsukhLandingSection() {
  return (
    <>
      ...
      <div id="about" className="self-stretch">
        <div>
          <div className="z-[4] relative flex flex-col items-center">
            <div className="h-[690px] relative self-stretch bg-blue_gray-900">
              <div className="bg-[url(/public/images/out.jpg)] py-[284px] pl-[196px] w-[74%] h-[690px] absolute bottom-0 left-0 top-0 my-auto flex items-center bg-cover bg-no-repeat pr-14 md:h-auto md:p-5"></div>
              <div className="bg-[url(/public/images/Vector.png)] py-[168px] pr-[142px] w-[70%] h-[690px] absolute bottom-0 right-0 top-0 my-auto flex items-center justify-end bg-cover bg-no-repeat pl-14 md:h-auto md:p-5">
                <div className="w-[56%] flex flex-col items-start md:w-full">
                  ...
                  >
                    ...
                    Dam, Maithon Dam, and the captivating Panchat Dam. Revel in
                    the embrace of comfort, relish delightful meals, and unwind
                    in our verdant garden oasis. Your ideal retreat beckons,
                    promising a harmonious blend of nature's beauty and
                    heartfelt hospitality. Explore the hidden gems of Purulia,
